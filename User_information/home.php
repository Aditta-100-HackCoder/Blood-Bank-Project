...
<?php include 'link.php';?>  
    ...
    <div class="main">
     ...
     <div id="layoutSidenav_content"> 
          ...
          <h1 style="color: Black;padding-left:320px;"> This is Users Page </h1>  
          <!--
...
<div class="card-body">
      ...
      <p class="card-text"><b>NAME:  <?php echo $User_Name;?> <br>Email: <?php echo $Email;?> <br>CONTACT: <?php echo $User_ContactNumber;?> <br>
       Gender: <?php echo $User_Gender;?> <br>Age: <?php echo $User_Age;?> </b></p>
...
<?php 
    if(isset($_POST['submit'])){ 
      ...
      $query = "Update user_info set image_name = '$image_name' where ID = $ID"; 
