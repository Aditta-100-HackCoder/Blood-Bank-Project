...
<html lang="en">
    <head>
        ...
        <title>Update UserPassword</title> 
...
<div class="login-title">
 <h2 style = "padding-top: 30px;padding-left: 400px;"> <b> Update User password <b> </h2>
</div>
...
$query = "UPDATE user_info SET Password = '$pass2' WHERE ID = $ID"; 
